...
module.exports = {
  ...
  // host: 'https://ratemy-landlord.herokuapp.com'
};
...
var landlordsHandlebars = function landlordsHandlebars(name, address) {
  var landlordHandlebarsTemplate = __webpack_require__(18);
  var context = {
    'name': name,
    'address': address
  };
  var landlordTemplate = landlordHandlebarsTemplate(context);
  $('#landlords-div').append(landlordTemplate);
};

// template context for pages/

var commentsHandlebars = function commentsHandlebars(subject, comment, rate) {
  var commentHandlebarsTemplate = __webpack_require__(35);
  var context = {
    'subject': subject,
    'comment': comment,
    'rate': rate
  };
  var templateFilled = commentHandlebarsTemplate(context);
  $('#empty-comments-div').append(templateFilled);
};

var dropdownHandlebars = function dropdownHandlebars(subject, dataId) {
  var commentHandlebarsTemplate = __webpack_require__(36);
  var context = {
    'subject': subject
  };
  var templateFilled = commentHandlebarsTemplate(context);
...
module.exports = {
  landlordsHandlebars: landlordsHandlebars,
  commentsHandlebars: commentsHandlebars,
  dropdownHandlebars: dropdownHandlebars
};
...
var onGetAllLandlords = function onGetAllLandlords(event) {
  event.preventDefault();
  api.getAllLandlords().then(ui.getAllLandlordsSuccess).catch(ui.getAllLandlordsFailure);
};

var onGetMyLandlords = function onGetMyLandlords(event) {
  console.log(app.user);
  event.preventDefault();
  api.getMyLandlords().then(ui.getMyLandlordsSuccess).catch(ui.getMyLandlordsFailure);
};

var onCreateLandlord = function onCreateLandlord(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.createLandlord(data).then(ui.createLandlordSuccess).catch(ui.createLandlordFailure);
};

var onUpdateLandlordSaveId = function onUpdateLandlordSaveId(event) {
...
var onUpdateLandlord = function onUpdateLandlord(event) {
  var data = getFormFields(this);
  var dataId = this.getAttribute('data-id');
  console.log('onUpdateLandlord dataId = ' + dataId);
  event.preventDefault();
  api.updateLandlord(data, dataId).then(ui.editLandlordSuccess).catch(ui.editLandlordFailure);
};

var onDeleteLandlord = function onDeleteLandlord(event) {
  var data = this.getAttribute('data');
  event.preventDefault();
  debugger;
  api.deleteLandlord(data).then(ui.deleteLandlordSuccess).catch(ui.deleteLandlordFailure);
};

var onGetAllComments = function onGetAllComments(event) {
  event.preventDefault();
  api.getAllComments().then(ui.getAllCommentsSuccess).catch(ui.getAllCommentsFailure);
};

var onGetAllMyComments = function onGetAllMyComments(event) {
  event.preventDefault();
  console.log(event);
  api.getAllMyComments().then(ui.getAllMyCommentsSuccess).catch(ui.getAllMyCommentsFailure);
};

var onGetOneComment = function onGetOneComment(event) {
  console.log('onGetOneComment called');
  var dataId = this.getAttribute('data-id');
  console.log('dataId = ' + dataId);
  api.getOneComment(dataId).then(ui.getOneCommentSuccess).catch(ui.getOneCommentFailure);
};
...
var onCreateComment = function onCreateComment(event) {
  ...
  console.log(data);
  event.preventDefault();
  api.createComment(data).then(ui.createCommentSuccess).then(onGetAllMyComments).catch(ui.createCommentFailure);
};

var onUpdateCommentSaveId = function onUpdateCommentSaveId(event) {
  var dataId = this.getAttribute('data-id');
...
var onUpdateComment = function onUpdateComment(event) {
  ...
  var dataId = this.getAttribute('data-id');
  event.preventDefault();
  api.updateComment(data, dataId).then(ui.updateCommentSuccess).catch(ui.updateCommentFailure);
};

var onDeleteComment = function onDeleteComment(event) {
  var dataId = this.getAttribute('data-id');
  event.preventDefault();
  api.deleteComment(dataId).then(ui.deleteCommentSuccess).then(onGetAllMyComments).catch(ui.deleteCommentFailure);
};
...
module.exports = {
  ...
  onGetAllLandlords: onGetAllLandlords,
  onGetMyLandlords: onGetMyLandlords,
  onCreateLandlord: onCreateLandlord,
  onUpdateLandlordSaveId: onUpdateLandlordSaveId,
  onUpdateLandlord: onUpdateLandlord,
  onDeleteLandlord: onDeleteLandlord,
  onGetAllComments: onGetAllComments,
  onGetAllMyComments: onGetAllMyComments,
  onCreateComment: onCreateComment,
  onUpdateCommentSaveId: onUpdateCommentSaveId,
  onUpdateComment: onUpdateComment,
  onGetOneComment: onGetOneComment,
...
var getAllLandlords = function getAllLandlords() {
  return $.ajax({
...
var getMyLandlords = function getMyLandlords() {
  console.log(app.user);
  return $.ajax({
...
var createLandlord = function createLandlord(data) {
  console.log(data);
  return $.ajax({
    url: config.apiOrigin + '/landlords',
    method: 'POST',
...
var updateLandlord = function updateLandlord(data, dataId) {
...
var deleteLandlord = function deleteLandlord(data) {
  return $.ajax({
...
var getAllMyComments = function getAllMyComments() {
  return $.ajax({
...
var getOneComment = function getOneComment(dataId) {
...
var deleteComment = function deleteComment(dataId) {
  return $.ajax({
    url: config.apiOrigin + '/comments/' + dataId,
    method: 'DELETE',
    headers: {
...
var updateComment = function updateComment(data, dataId) {
...
var getAllLandlordsSuccess = function getAllLandlordsSuccess(data) {
  console.log(data);
  console.log('Successfully retrieved all landlords by all users');
  $('#landlords-div').empty();
  for (var i = 0; i < data.landlords.length; i++) {
    var name = data.landlords[i].firstname;
    var address = data.landlords[i].address;
    template.landlordsHandlebars(name, address);
  }
  $('.landlordsEditButton, .landlordsDeleteButton').hide();
};
var getAllLandlordsFailure = function getAllLandlordsFailure(err) {
  console.log(err);
...
var getMyLandlordsSuccess = function getMyLandlordsSuccess(data) {
  console.log(data);
  ...
  for (var i = 0; i < data.landlords.length; i++) {
    var name = data.landlords[i].firstname;
    var comment = data.landlords[i].comments;
    template.landlordsHandlebars(name, comment);
  }
};

var getMyLandlordsFailure = function getMyLandlordsFailure(error) {
  console.log('Failed');
  $('#landlords-div').html('These Are Not The landlords You Are Looking For');
  console.log(error);
};

var getAllCommentsSuccess = function getAllCommentsSuccess(data) {
  var comments = data.comments;
  for (var i = 0; i < comments.length; i++) {
    var subject = comments[i].subject;
    var comment = comments[i].comment;
    var rate = comments[i].rate;
...
var getOneCommentSuccess = function getOneCommentSuccess(data) {
  console.log('succeeded in getOneCommentSuccess');
  // assign for edit or delete
  app.comment = data.comment;
  console.log(app.comment);
  $('#comments-div').empty();
  var subject = data.comment.subject;
  var comment = data.comment.sections.comment;
  var rate = data.comment.rate;
  console.log(subject + comment + rate);
  template.commentsHandlebars(subject, comment, rate);
};

var getAllCommentsFailure = function getAllCommentsFailure(error) {
  console.log(error);
  console.log('Failed in getAllCommentsFailure');
};

var getAllMyCommentsSuccess = function getAllMyCommentsSuccess(data) {
  console.log('I getAllMyCommentsSuccess');
  console.log(data);
  console.log('Succeded');
  $('#listOfComments').empty();
  for (var i = 0; i < data.comments.length; i++) {
    var dataId = data.comments[i].id;
    var subject = data.comments[i].subject;
    var comment = data.comment[i].comment;
    var rate = data.comment[i].rate;
    template.commentsHandlebars(subject, comment, rate, dataId);
  }
};

var getAllMyCommentsFailure = function getAllMyCommentsFailure(error) {
  console.log(error);
...
var createCommentFailure = function createCommentFailure(error) {
  console.log(error);
  console.log('Failed in createCommentFailure');
};

var createLandlordSuccess = function createLandlordSuccess(data) {
  console.log(data);
  console.log('Succeded in createLandlordSuccess');
  $('textarea').val('');
};

var createLandlordFailure = function createLandlordFailure(error) {
  console.log(error);
...
var deleteCommentFailure = function deleteCommentFailure(error) {
  console.log(error);
  console.log('Failed in delete Comment Failure');
};

var deleteLandlordSuccess = function deleteLandlordSuccess(data) {
  console.log(data);
  console.log('Succeded in delete Landlord Success');
};

var deleteLandlordFailure = function deleteLandlordFailure(error) {
  console.log(error);
...
var updateCommentFailure = function updateCommentFailure(error) {
  console.log(error);
  console.log('Failed in updateCommentFailure');
};

var updateLandlordSuccess = function updateLandlordSuccess(data) {
  console.log(data);
  console.log('Succeded in deleteLandlordSuccess');
  $('#lanlords-div').empty();
  for (var i = 0; i < data.landlord.length; i++) {
    var name = data.landlord[i].name;
    var address = data.landlord[i].address;
    template.landlordsHandlebars(name, address);
  }
};

var updateLandlordFailure = function updateLandlordFailure(error) {
  console.log(error);
...
module.exports = {
  ...
  getMyLandlordsSuccess: getMyLandlordsSuccess,
  getMyLandlordsFailure: getMyLandlordsFailure,
  getAllLandlordsSuccess: getAllLandlordsSuccess,
  getAllLandlordsFailure: getAllLandlordsFailure,
  getAllCommentsSuccess: getAllCommentsSuccess,
  getAllCommentsFailure: getAllCommentsFailure,
  getOneCommentSuccess: getOneCommentSuccess,
  getAllMyCommentsSuccess: getAllMyCommentsSuccess,
  getAllMyCommentsFailure: getAllMyCommentsFailure,
  createLandlordSuccess: createLandlordSuccess,
  createCommentSuccess: createCommentSuccess,
  createCommentFailure: createCommentFailure,
  createLandlordFailure: createLandlordFailure,
  deleteCommentSuccess: deleteCommentSuccess,
  deleteLandlordSuccess: deleteLandlordSuccess,
  deleteCommentFailure: deleteCommentFailure,
  deleteLandlordFailure: deleteLandlordFailure,
  updateCommentSuccess: updateCommentSuccess,
  updateCommentFailure: updateCommentFailure,
  updateLandlordSuccess: updateLandlordSuccess,
  updateLandlordFailure: updateLandlordFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"landlords-div\" class=\"landlords-div\" data-id=\""
    ...
    + "</p>\n  <button type=\"button\" class=\"landlordEditButton\" data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
    + "\" name=\"editButton\">Edit</button>\n  <button type=\"button\" class=\"landlordDeleteButton\" data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"comments-div\" data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
    + "\">\n  <h1>"
    ...
    + "</p>\n  <button type=\"button\" class=\"commentsEditButton\" data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"comments-dropdown-comment-list\">\n  <p id='comments-dropdown-comment-subject' data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
    + "\">"
    + alias4(((helper = (helper = helpers.subject || (depth0 != null ? depth0.subject : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"subject","hash":{},"data":data}) : helper)))
    + "</p>\n</div>\n";
